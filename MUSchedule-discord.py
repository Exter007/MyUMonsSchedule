...
from setup import login_file_name
...
url = "https://discord.com/channels/903586567988342816/903587301962178570/903642832529674361"
discord = Discord(url=url)

# Fichier config
config_file = open(f"./config/{login_file_name}.txt", "r")
